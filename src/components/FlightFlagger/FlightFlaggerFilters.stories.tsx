...
import { FlightFlaggerFilters as FlightFlaggerFiltersComponent, SearchFilterPayload } from "./FlightFlaggerFilters";
...
const Template: ComponentStory<typeof FlightFlaggerFiltersComponent> = (args) => <ThemeProvider theme={defaultTheme}><FlightFlaggerFiltersComponent {...args} /></ThemeProvider>;
