...
export const PaxTerminalOverview: Story = {
  ...
  render: () => {
      ...
      return (
        <Box p={2}>
          <PaxTerminalOverviewComponnet flights={args.flights} chartData={args.chartData} pressure={args.pressure} estimates={args.estimates} desks={args.desks} staff={args.staff} />
        </Box>
      )
  }
};
