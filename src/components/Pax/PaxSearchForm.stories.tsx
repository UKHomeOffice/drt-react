      ...
      <LocalizationProvider dateAdapter={AdapterMoment}>
        <Box sx={(theme) => ({
          ...
          <Grid container spacing={2} flexWrap={'nowrap'}>
            <Grid item>
              <Stack spacing={2}>
                <ToggleButtonGroup exclusive color='primary' size='medium' value={storyContext.day}>
                  <ToggleButton value="yesterday" defaultChecked>Yesterday</ToggleButton>
                  <ToggleButton value="today">Today</ToggleButton>
                  <ToggleButton value="tomorrow">Tomorrow</ToggleButton>
                </ToggleButtonGroup>
                <ToggleButtonGroup exclusive color='primary' size='medium' value={storyContext.time}>
          ...
          <Stack direction="row" sx={{alignItems: 'center', mt: 1}}>
            ...
            <Switch id="time-machine" checked={storyContext.timeMachine} />
            <Typography variant='body1'>{storyContext.timeMachine ? 'On' : 'Off'}</Typography>
          </Stack>
        </Box>
