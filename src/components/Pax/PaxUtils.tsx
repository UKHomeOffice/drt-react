...
export const getPaxContent = (status: DatasourceStatus) : PaxStatusContent =>  {
  ...
  switch (status) {
    case DatasourceStatus.PortForecast:
      ...
      content.icon = <WarningIcon style={{height: '0.8em', width: '0.8em'}} color={content.paxColor as any} />
      break;
    case DatasourceStatus.DRTForecast:
      ...
      content.icon = <CheckIcon style={{color: 'white', width: '55%', marginLeft: '3px', height: '0.8em'}}  />
      content.iconBg = <CircleIcon style={{height: '0.8em', width: '0.8em'}} color='info' />
      break;
    case DatasourceStatus.PortLiveData:
      content.paxColor = "success"
      content.statusText = "Live data from the port operator";
      content.icon = <CheckIcon style={{color: 'white', width: '55%', marginLeft: '3px', height: '0.8em'}}  />
      content.iconBg = <ShieldIcon style={{height: '0.8em', width: '0.8em'}} color='success' />
      break;
    ...
    case DatasourceStatus.Estimate:
      ...
      content.iconBg = <HexagonIcon style={{color: 'white', marginLeft: '2px', height: '0.8em', width: '0.8em'}} />
      break;
