...
export const ConfirmRemoveShift = ({
  ...
  return (
    <Box sx={{p: 2, minWidth: '500px'}}>
      <Typography variant="h1">Are you sure you want to remove this shift?</Typography>
          <Box key={shift.id}
               sx={{maxWidth: '500px', backgroundColor: 'transparent', border: '1px solid #ddd', marginBottom: '10px',}}>
            <Box component="dl" sx={{
              display: 'flex',
