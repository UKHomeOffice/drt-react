  ...
  return (
    <Box sx={{maxWidth: '70%'}}>
      ...
      <Section id="introduction">
        ...
        <Typography variant="body1" mb={2}>This accessibility statement applies to <Link href="https://drt.homeoffice.gov.uk/" rel="noopener noreferrer">https://drt.homeoffice.gov.uk/</Link>. This website is run by Technology Delivery Centre, part of Home Office Digital Directorate's Migration and Borders Technology Portfolio, on behalf of Border Force. We want as many people as possible to be able to use this website. For example, that means you should be able to:</Typography>
        <List className='inline-disc-items'>
